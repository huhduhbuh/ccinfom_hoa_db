...
CREATE TABLE IF NOT EXISTS incidents (
    ...
    INDEX (investigating_officer_id ASC),
    FOREIGN KEY (investigating_officer_id) 
		REFERENCES hoa_officer(officer_id),
	INDEX (seconding_officer_id ASC), 
	FOREIGN KEY (seconding_officer_id)
		REFERENCES hoa_officer(officer_id)
);
...
CREATE TABLE IF NOT EXISTS evidence (
    ...
    FOREIGN KEY (incident_id)
		REFERENCES incidents(incident_id),
    INDEX (submitting_resident_id ASC),
